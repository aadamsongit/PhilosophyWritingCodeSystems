...
Data structures and algorithms, system design, feature implementation, AI-assisted coding, debugging, take-home projects, and verbal technical discussions all look different on the surface. Underneath, they exercise many of the same cognitive skills. Each asks you to understand a problem, decompose it into smaller pieces, make tradeoffs, communicate your reasoning, and arrive at a solution. The medium changes. The underlying skill largely does not.

That doesn't mean every interview format is equally effective or equally predictive of job performance. They each have strengths and weaknesses. But searching for the interview format that is "easiest" can distract from developing the skill they have in common. If your ability to decompose problems improves, you'll likely become stronger across interview formats rather than only improving at one of them.
